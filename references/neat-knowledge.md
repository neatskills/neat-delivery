...
|-------|---------|------|----------|-------|
| **neat-delivery-analysing** | After saving analysis + specs | `analysis-<product>.md` | analysis | Detects KB, writes path to specs.md |
...
| **neat-delivery-building** | Feature `state: implemented` | `feature-{goal}-{nn}-{slug}.md` | features | Only implemented features ingested |
